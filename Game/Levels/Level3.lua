...
function createBackgroundPainting()
    ...
    setSprite(backgroundPainting, 0, 0, 1920, 1440)
    setTexture(backgroundPainting, "../Game/map001.png")
...
function createCharacterEntity(posX, posY, width, height)
    -- Create Player Object
    local entity = createEntity()
    logMessage("[INFO] Lua created Entity: " .. entity);
    attachComponent(entity, ComponentTypes.Transform)
    attachComponent(entity, ComponentTypes.Physics)
    attachComponent(entity, ComponentTypes.Collider)
    attachComponent(entity, ComponentTypes.Renderable)
    attachComponent(entity, ComponentTypes.Sprite)
    attachComponent(entity, ComponentTypes.Texture)
    attachComponent(entity, ComponentTypes.Animation)
    setSprite(entity, posX, posY, width, height)
    setTexture(entity, "../Game/Assets/hero_WalkCycleDown1.png")
    setRenderLayer(entity, RenderLayer.character)
    setTransform(entity, posX, posY);
    setBoundaryBox(entity, posX, posY, 32, 32)

    -- Load WalkCycleDown
    addFrame(entity, AnimationType.WalkCycleDown, "../Game/Assets/hero_WalkCycleDown1.png")
    addFrame(entity, AnimationType.WalkCycleDown, "../Game/Assets/hero_WalkCycleDown2.png")
    addFrame(entity, AnimationType.WalkCycleDown, "../Game/Assets/hero_WalkCycleDown3.png")
    addFrame(entity, AnimationType.WalkCycleDown, "../Game/Assets/hero_WalkCycleDown4.png")
    addFrame(entity, AnimationType.WalkCycleDown, "../Game/Assets/hero_WalkCycleDown5.png")

    --Load WalkCycleUp
    addFrame(entity, AnimationType.WalkCycleUp, "../Game/Assets/hero_WalkCycleUp1.png")
    addFrame(entity, AnimationType.WalkCycleUp, "../Game/Assets/hero_WalkCycleUp2.png")
    addFrame(entity, AnimationType.WalkCycleUp, "../Game/Assets/hero_WalkCycleUp3.png")
    addFrame(entity, AnimationType.WalkCycleUp, "../Game/Assets/hero_WalkCycleUp4.png")
    addFrame(entity, AnimationType.WalkCycleUp, "../Game/Assets/hero_WalkCycleUp5.png")

    --Load WalkCycleLeft
    addFrame(entity, AnimationType.WalkCycleLeft, "../Game/Assets/hero_WalkCycleLeft1.png")
    addFrame(entity, AnimationType.WalkCycleLeft, "../Game/Assets/hero_WalkCycleLeft2.png")
    addFrame(entity, AnimationType.WalkCycleLeft, "../Game/Assets/hero_WalkCycleLeft3.png")
    addFrame(entity, AnimationType.WalkCycleLeft, "../Game/Assets/hero_WalkCycleLeft4.png")
    addFrame(entity, AnimationType.WalkCycleLeft, "../Game/Assets/hero_WalkCycleLeft5.png")

    --Load WalkCycleRight
    addFrame(entity, AnimationType.WalkCycleRight, "../Game/Assets/hero_WalkCycleRight1.png")
    addFrame(entity, AnimationType.WalkCycleRight, "../Game/Assets/hero_WalkCycleRight2.png")
    addFrame(entity, AnimationType.WalkCycleRight, "../Game/Assets/hero_WalkCycleRight3.png")
    addFrame(entity, AnimationType.WalkCycleRight, "../Game/Assets/hero_WalkCycleRight4.png")
    addFrame(entity, AnimationType.WalkCycleRight, "../Game/Assets/hero_WalkCycleRight5.png")
...
function constructLevel()
    ...
    createCharacterEntity(525, 460, 96, 128);
