...
function Player.createPlayerEntity(posX, posY, width, height)
    ...
    setTexture(entityUID, "../TopDown_Game/assets/animation/hev_WalkDown1.png")
    ...
    -- Load WalkCycleDown
    addFrame(entityUID, AnimationType.WalkCycleDown, "../TopDown_Game/assets/animation/hev_walkDown1.png")
    addFrame(entityUID, AnimationType.WalkCycleDown, "../TopDown_Game/assets/animation/hev_walkDown2.png")
    addFrame(entityUID, AnimationType.WalkCycleDown, "../TopDown_Game/assets/animation/hev_walkDown3.png")
    addFrame(entityUID, AnimationType.WalkCycleDown, "../TopDown_Game/assets/animation/hev_walkDown4.png")
    addFrame(entityUID, AnimationType.WalkCycleDown, "../TopDown_Game/assets/animation/hev_walkDown5.png")

    --Load WalkCycleUp
    addFrame(entityUID, AnimationType.WalkCycleUp, "../TopDown_Game/assets/animation/hev_WalkUp1.png")
    addFrame(entityUID, AnimationType.WalkCycleUp, "../TopDown_Game/assets/animation/hev_WalkUp2.png")
    addFrame(entityUID, AnimationType.WalkCycleUp, "../TopDown_Game/assets/animation/hev_WalkUp3.png")
    addFrame(entityUID, AnimationType.WalkCycleUp, "../TopDown_Game/assets/animation/hev_WalkUp4.png")
    addFrame(entityUID, AnimationType.WalkCycleUp, "../TopDown_Game/assets/animation/hev_WalkUp5.png")

    --Load WalkCycleLeft
    addFrame(entityUID, AnimationType.WalkCycleLeft, "../TopDown_Game/assets/animation/hev_WalkLeft1.png")
    addFrame(entityUID, AnimationType.WalkCycleLeft, "../TopDown_Game/assets/animation/hev_WalkLeft2.png")
    addFrame(entityUID, AnimationType.WalkCycleLeft, "../TopDown_Game/assets/animation/hev_WalkLeft3.png")
    addFrame(entityUID, AnimationType.WalkCycleLeft, "../TopDown_Game/assets/animation/hev_WalkLeft4.png")
    addFrame(entityUID, AnimationType.WalkCycleLeft, "../TopDown_Game/assets/animation/hev_WalkLeft5.png")

    --Load WalkCycleRight
    addFrame(entityUID, AnimationType.WalkCycleRight, "../TopDown_Game/assets/animation/hev_WalkRight1.png")
    addFrame(entityUID, AnimationType.WalkCycleRight, "../TopDown_Game/assets/animation/hev_WalkRight2.png")
    addFrame(entityUID, AnimationType.WalkCycleRight, "../TopDown_Game/assets/animation/hev_WalkRight3.png")
    addFrame(entityUID, AnimationType.WalkCycleRight, "../TopDown_Game/assets/animation/hev_WalkRight4.png")
    addFrame(entityUID, AnimationType.WalkCycleRight, "../TopDown_Game/assets/animation/hev_WalkRight5.png")
