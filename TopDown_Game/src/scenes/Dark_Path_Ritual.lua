...
registerKeyDownCallback(KeyCode.ARROW_UP, function() player.moveUp(KeyCode.ARROW_UP) end)
registerKeyUpCallback(KeyCode.ARROW_UP, function() player.stopMoveUp(KeyCode.ARROW_UP) end)
