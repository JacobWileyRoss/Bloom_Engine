...
function createBackgroundPainting()
    ...
    setTexture(backgroundPainting, "../../Editor/Game/Assets/background_DarkPath_Ritual_Scene.png")
...
function createPlayerEntity(posX, posY, width, height)
    ...
    setTexture(player, "../../Editor/Game/Assets/hero_WalkCycleDown1.png")
    ...
    -- Load WalkCycleDown
    addFrame(player, AnimationType.WalkCycleDown, "../../Editor/Game/Assets/hero_WalkCycleDown1.png")
    addFrame(player, AnimationType.WalkCycleDown, "../../Editor/Game/Assets/hero_WalkCycleDown2.png")
    addFrame(player, AnimationType.WalkCycleDown, "../../Editor/Game/Assets/hero_WalkCycleDown3.png")
    addFrame(player, AnimationType.WalkCycleDown, "../../Editor/Game/Assets/hero_WalkCycleDown4.png")
    addFrame(player, AnimationType.WalkCycleDown, "../../Editor/Game/Assets/hero_WalkCycleDown5.png")

    --Load WalkCycleUp
    addFrame(player, AnimationType.WalkCycleUp, "../../Editor/Game/Assets/hero_WalkCycleUp1.png")
    addFrame(player, AnimationType.WalkCycleUp, "../../Editor/Game/Assets/hero_WalkCycleUp2.png")
    addFrame(player, AnimationType.WalkCycleUp, "../../Editor/Game/Assets/hero_WalkCycleUp3.png")
    addFrame(player, AnimationType.WalkCycleUp, "../../Editor/Game/Assets/hero_WalkCycleUp4.png")
    addFrame(player, AnimationType.WalkCycleUp, "../../Editor/Game/Assets/hero_WalkCycleUp5.png")

    --Load WalkCycleLeft
    addFrame(player, AnimationType.WalkCycleLeft, "../../Editor/Game/Assets/hero_WalkCycleLeft1.png")
    addFrame(player, AnimationType.WalkCycleLeft, "../../Editor/Game/Assets/hero_WalkCycleLeft2.png")
    addFrame(player, AnimationType.WalkCycleLeft, "../../Editor/Game/Assets/hero_WalkCycleLeft3.png")
    addFrame(player, AnimationType.WalkCycleLeft, "../../Editor/Game/Assets/hero_WalkCycleLeft4.png")
    addFrame(player, AnimationType.WalkCycleLeft, "../../Editor/Game/Assets/hero_WalkCycleLeft5.png")

    --Load WalkCycleRight
    addFrame(player, AnimationType.WalkCycleRight, "../../Editor/Game/Assets/hero_WalkCycleRight1.png")
    addFrame(player, AnimationType.WalkCycleRight, "../../Editor/Game/Assets/hero_WalkCycleRight2.png")
    addFrame(player, AnimationType.WalkCycleRight, "../../Editor/Game/Assets/hero_WalkCycleRight3.png")
    addFrame(player, AnimationType.WalkCycleRight, "../../Editor/Game/Assets/hero_WalkCycleRight4.png")
    addFrame(player, AnimationType.WalkCycleRight, "../../Editor/Game/Assets/hero_WalkCycleRight5.png")
